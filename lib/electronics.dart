...
class _ElectronicsState extends State<Electronics> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('donations').where('category', isEqualTo: 'Electronics').where('is_posted', isEqualTo: true).where('is_requested', isEqualTo: false).snapshots(), 
