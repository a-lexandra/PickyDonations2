...
class Clothes extends StatefulWidget{
  ...
  @override
  State<Clothes> createState() {
    return _ClothesState();
  }
}
...
class _ClothesState extends State<Clothes> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('donations').where('category', isEqualTo: 'Clothes').where('is_posted', isEqualTo: true).where('is_requested', isEqualTo: false).snapshots(), 
