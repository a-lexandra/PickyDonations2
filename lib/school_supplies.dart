...
class _SchoolSuppliesState extends State<SchoolSupplies> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('donations').where('category', isEqualTo: 'SchoolSupplies').where('is_posted', isEqualTo: true).where('is_requested', isEqualTo: false).snapshots(), 
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if(user['account_type'] == 'volunteer')...[
                IconButton(
                  onPressed: () async {
                    //este scos de pe lista principala;
                    //este adaugat in lista voluntarului care i a dat request
                    //si doar el si adminul il mai pot vedea;
                    //daca admin da accept atunci dispare de tot;
                    //daca admin da reject atunci se intoarce in lista principala
                    //si dispare din lista voluntarului
